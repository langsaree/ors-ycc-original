            ...
            <div class="Columns">
                <div class="MainColumn">
                    <div class="ArticleBorder">
                        ...
                        //$login = $email = $pswd = $cpswd = $first_name = $name = $s_name = $filename = "";
...
#=================================
	  ...
	  !$errmsg25 && !$errmsg26 && !$errmsg27 && !$errmsg28 && !$errmsg29 */ && !$errmsg30)
                            {
                                $query = "INSERT INTO student (username,password,first_name,name,s_name,gender,birthday,std_id,address,city,province,postalcode,phone,email,job,nation,origin,religion,edulevel,eduplace,eduprovince,eduyear) 
