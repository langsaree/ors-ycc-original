  ...
  <tr>
    <td width="831" height="325" valign="top" ><table  width="819" height="250" border="0" cellpadding="0" cellspacing="2" >
      ...
      <tr>
        ...
        <td class="style41"><a href="register_course.php" class="style41">การจัดการสถานะนักศึกษา</td>
        ...
        <td class="style41"><a href="register_course.php" class="style41">ด้าต้าเบส</td>
      </tr>
      <tr>
        <td class="style41">&nbsp;</td>
        <td class="style41">&nbsp;</td>
