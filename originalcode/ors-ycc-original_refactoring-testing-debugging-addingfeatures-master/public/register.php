            ...
            <div class="Menu">
                <ul>
                    ...
                    <a href="index.php" class="MenuButton"><span>หน้าหลัก</span></a><a href="college.php"
                                                                                       class="MenuButton"> <span> วิทยาลัย</span></a><a
                            href="course.php" class="MenuButton"><span>หลักสูตร</span></a><a href="ann.php"
                                                                                             class="MenuButton"><span>ประชาสัมพันธ์</span>
                    </a><a href="gallary.php" class="MenuButton"><span>ภาพกิจกรรม</span></a><a href="contact_us.php"
                                                                                               class="MenuButton"><span> ติดต่อเรา</span></a>
            ...
            <div class="Columns">
                <div class="Column1">
                    <div class="Block">
                        ...
                        <table width="150" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div align="center"><a href="register.php"><img src="images/register.gif"
                ...
                <div class="MainColumn">
                    <div class="ArticleBorder">
                        ...
                        <div class="Article">
                            <table width="650" height="251" border="0" cellpadding="0" cellspacing="0"
                                   bordercolor="#999999">
                                <tr>
                                    <td width="304" height="251" valign="top">
                                        <table width="298" height="224" border="0" cellpadding="0" cellspacing="0"
                                               bordercolor="#CCCCCC" bgcolor="#CCCCCC">
                                            <tr bgcolor="#0099FF">
                                                <td height="39" colspan="3" bgcolor="#0099FF"><span class="style29">&nbsp;สำหรับผู้ที่ลงทะเบียนเรียนครั้งแรก</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="81" colspan="3" valign="top" bgcolor="#CCCCCC">&nbsp;&nbsp;หากคุณยังไม่เคยลงทะเบียนเรียนมาก่อน<br>
                                                    &nbsp;&nbsp;คุณสามารถคลิกที่ปุ่ม ลงทะเบียนเรียนใหม่ &nbsp;&nbsp;เพื่อกรอกข้อมูลต่างๆ
                                                    เพื่อใช้ในการเรียนหลักสูตร<br>
                                                    &nbsp;&nbsp;ของวิทยาลัยชุมชนกรุงเทพมหานครค่ะ
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="43" bgcolor="#CCCCCC">&nbsp;</td>
                                                <td bgcolor="#CCCCCC"><input type="submit" name="button" id="button"
                                                                             value="ลงทะเบียนเรียนใหม่"
                                    ...
                                    <td width="346" valign="top">
                                        <form action="std_login_check.php" method="POST">
                                            <table width="336" height="211" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td height="39" colspan="3" bgcolor="#0099FF"><span class="style29"> &nbsp;สำหรับผู้ที่เคยลงทะเบียนแล้ว</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="72" colspan="3" valign="top" bgcolor="#CCCCCC">&nbsp;&nbsp;หากคุณเคยลงทะเบียนเรียนหลักสูตรของทาง
                                                        <br>
                                                        &nbsp;&nbsp;วิทยาลัยชุมชนยะลาแล้ว คุณสามารถใส่ <strong> <br>
                                                            &nbsp;&nbsp;ชื่อล็อกอิน</strong>
                                                        และ<strong>รหัสผ่าน</strong> ของคุณ <br>
                                                ...
                                                <tr>
                                                    <td colspan="3" bgcolor="#CCCCCC">
                                                        ...
                                                        // display an error from checking std login check.php
                                                        if (!empty($std_error)) {

                                                            echo "<span style=\"color:red\">$std_error</span>";
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="233" bgcolor="#CCCCCC"><span
                                                                class="style9">ล็อกอิน::</span></td>
                                                ...
                                                <tr>
                                                    <td bgcolor="#CCCCCC">&nbsp;</td>
                                                    <td bgcolor="#CCCCCC"><input type="submit" name="submit" id="ok2"
                                                                                 value="เข้าสู่ระบบ"/>
