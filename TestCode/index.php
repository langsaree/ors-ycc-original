<?php
session_start();
include('../TestCode/include/login.php');
?>
          ...
          <br>
            <table width="570" border="0" align="center" cellpadding="0" cellspacing="2">
              ...
              <tr>
                ...
                <td> <a href="pdf.php?id=<?=$row["cos_id"]; ?>" style="color: #333; text-decoration: none">ดาวน์โหลดผังการเรียน </a> </td>
                <td width="112"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
...
<? } ?>
    ...
    <?php  include('../TestCode/include/footer.php');?>
</body>
</html>