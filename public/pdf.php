...
<table width="808" height="972" border="0" align="left" cellpadding="0" cellspacing="2">
    <tr>
        ...
        <td width="716" align="center" valign="top">
            <table width="693" height="148" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="693" height="110" align="center" valign="top"><p><img src="images/Logo_Stamp_Small.jpg"
                                                                                     width="116" height="104"/></p></td>
                </tr>
                <tr>
                    <td>
                        <div align="center"><strong>ใบสมัครและลงทะเบียนหลักสูตรระยะสั้นในวิทยาลัยชุมชนยะลา
                                จังหวัดยะลา </strong></div>
                    </td>
                </tr>
                <tr>
                    <td></td>
            ...
            <table width="710" border="0" align="left" cellpadding="0" cellspacing="2">
                ...
                <tr>
                    ...
                    <td width="420"></td>
                    <td width="95">&nbsp;</td>
                    <td width="99" rowspan="2" align="left" valign="top">
                        <table width="84" height="98" border="1" align="center" cellpadding="0" cellspacing="0"
                               bordercolor="#333333">
                            <tr>

                                <td width="80" height="96" style="font-size: 10px; text-align: center;">รูปถ่าย 1 นิ้ว
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td height="92" colspan="4" valign="top">
                        ...
                        <table width="600" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                                ...
                                <td width="240"><?php echo  $row['job'] ?></td>
                ...
                <tr>
                    <td height="194" colspan="5" valign="top">
                        <table width="600" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                        ...
                        <table width="600" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                                ...
                                <!--                <td width="209">-->
                                <? //= $row['fat_fname'],' ',$row['fat_lname']?><!--</td>-->
                        ...
                        <table width="600" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                                ...
                                <!--                <td width="211">-->
                                <? //= $row['mot_fname'],' ',$row['mot_lname']?><!--</td>-->
            ...
            <table width="712" height="96" border="0" align="left" cellspacing="2">
                <tr>
                    <td width="706" height="92" valign="top">
                        <table width="705" border="1" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="231">
                                    <div align="center">วิชา</div>
                                </td>
                                <td width="107">
                                    <div align="center">จำนวนชั่วโมง/หน่วยกิต</div>
                                </td>
                                <td width="149">
                                    <div align="center">วันที่เข้าเรียน</div>
                                </td>
                                <td width="174">
                            ...
                            <tr>
                                ...
                                <td valign="top" align="center"><?php echo  $row1['cos_period'] ?></td>
                                <td valign="top" align="center"><?php echo  $row1['cos_day'] ?></td>
            ...
            <table width="660" height="109" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="323">
                        <table width="320" height="112" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <div align="center">
                                        ลงชื่อ...................................................ผู้สมัคร
                            ...
                            <tr>
                                <td>
                                    <div align="center">วันที่......เดือน...........................พ.ศ. ..........
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td width="316">
                        <table width="370" height="112" border="0" cellspacing="0">
                            <tr>
                                <td width="364">
                                    <div align="center">
                                        ลงชื่อ.....................................................ผู้รับสมัคร
            ...
            <table width="569" height="169" border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="3" valign="top">
                        <table width="517" height="112" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="511">
                                    ได้รับเงินค่าลงทะเบียนเรียนจำนวน.....................................................บาท
                                </td>
                            </tr>
                            <tr>
                                <td height="35">
                ...
                <tr>
                    ...
                    <td width="29">&nbsp;</td>
                    <td width="385">
                        <table width="373" height="112" border="0" align="left" cellspacing="2">
                            <tr>
                                <td width="367">
                                    <div align="center">
