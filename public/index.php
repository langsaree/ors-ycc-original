            ...
            <table width="601" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td height="26" colspan="3"
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Article">วิชาที่เปิดสอนประจำเดือน</span>มกราคม
                        2554
                    </td>
                </tr>
                <tr>
                ...
                <table width="570" border="0" align="center" cellpadding="0" cellspacing="2">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="font-weight:bold;"><span
                                    class="o">ชื่อวิชา :: &nbsp;</span><?= $row["cos_name"]; ?></td>
                    </tr>
                    <tr>
                        <td style="color: #333">&nbsp;</td>
                        <td><a href="pdf.php?id=<?= $row["cos_id"]; ?>" style="color: #333; text-decoration: none">ดาวน์โหลดผังการเรียน </a>
                        </td>
                        <td width="112"></td>
                    </tr>
                    <tr>
