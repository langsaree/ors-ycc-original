                ...
                <div class="Column1">
                    ...
                    <div class="Block">
                        ...
                        <div class="BlockContentBorder">
                            <ul>
                                <li><span class="style7"><a href="lec_view_cos.php"
                                                            style="color: #3987FB; text-decoration: none">แสดงข้อมูลวิชา</a></span>
                                </li>
                                <li><span class="style7"><a href="lec_view_student.php"
                                                            style="color: #3987FB; text-decoration: none">แสดงรายชื่อนักศึกษา</a></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" name="form1">
                                <table width="600">
                                    ...
                                    <tr>
                                        ...
                                        <td width="284"><p><img src="images/lecturer.png" alt="" width="124"
                                                                height="120"></p></td>
                                        <td width="81">&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="login" id="login" class="inputbox-normal"
                                                   value="<?= $row['username']; ?>">
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><label for="pswd"></label>
                                            <input type="password" name="pswd" id="pswd" class="inputbox-normal"
                                    ...
                                    <tr>
                                        ...
                                        <td><label for="name"></label>
                                            <input type="text" name="name" id="name" class="inputbox-normal"
                                                   value="<?= $row['lec_name']; ?>"></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        ...
                                        <td><label for="email"></label>
                                            <input type="text" name="email" id="email" class="inputbox-normal"
                                                   value="<?= $row['lec_email']; ?>"></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        ...
                                        <td><label for="phone"></label>
                                            <input type="text" name="phone" id="phone" class="inputbox-normal"
                                                   value="<?= $row['lec_tel']; ?>"></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
