                                    ...
                                    <tr>
                                        ...
                                        <td width="659" height="951" align="right" valign="top">
                                            ...
                                            <table width="600" border="0" align="center" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td height="19">&nbsp;</td>
                                                    <td style="text-align: right"><span class="style60">ศาสนา :</span>
                                                    </td>
                                                    <td><label for="religion"></label>
                                                        <input name="religion" type="text" id="religion"
                                                               value="<?= $row['religion']; ?>"></td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td style="text-align: right; font-weight: bold; color: #333;">เพศ
                                                        :</span></span></td>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td style="text-align: right"><span class="style60">จบการศึกษาระดับ :</span>
                                                    </td>
                                                    <td><label for="edulevel"></label>
                                                        <input type="text" name="edulevel" id="edulevel"
                                                               value="<?= $row['edulevel']; ?>"></td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td style="text-align: right">ป<span
                                                                class="style60">ีการศึกษา :</span></td>
                                                    <td><label for="eduyear"></label>
                                                        <input type="text" name="eduyear" id="eduyear"
                                                               value="<?= $row['eduyear']; ?>"></td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td style="text-align: right; font-weight: bold; color: #333;">อาชีพ
                                                        :</span></span></td>
