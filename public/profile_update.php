        ...
        <div class="Border">
            ...
            <div class="Menu">
                <ul>
                    ...
                    <li></li>
                    <li></li>
                    <a href="index.php" class="MenuButton"><span>หน้าหลัก</span></a><a href="#" class="MenuButton">
                        <span>วิทยาลัย</span></a><a href="#" class="MenuButton"><span>หลักสูตร</span></a><a href="#"
                                                                                                            class="MenuButton"><span>ประชาสัมพันธ์</span>
                    </a><a href="#" class="MenuButton"><span>ภาพกิจกรรม</span></a><a href="#" class="MenuButton"><span> ติดต่อเรา</span></a>
                        ...
                        <table width="170" border="0" align="left" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td><span class="style64"><span
                                                style="color: #2192CF">ยินดีต้อนรับ</span> ::</span> <?php echo '<span style="font-weight:bold; color:#000 font-size:15px"> ' . $username . '</span>'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                    ...
                    <div class="ArticleBorder">
                        ...
                        <div class="Article">
                            <form action="" method="POST">
                                <table width="650" height="961" border="0" align="center" cellpadding="0"
                                       cellspacing="5">
                                    <tr>
                                        ...
                                        <td width="659" height="951" align="right" valign="top">
                                            ...
                                            <table width="637" height="50" border="0" cellpadding="0" cellspacing="5">
                                                <tr>
                                                    <td
                                                            ...
                                                            width="455" height="18" valign="middle">&nbsp;
                                                    </td>
                                                    <td width="79" valign="middle" class="style33"><a
                                                                href="std_profile.php" class="style67"
                                                                style="text-decoration: none">ดูข้อมูลส่วนตัว</a></td>
                                                    <td style="text-align:center"><strong><a href="logout.php"><span
                                                                        class="glyphicon glyphicon-log-out"></span>ออกจากระบบ</a></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="17" colspan="3" valign="middle"><span class="style56">----------------------------------------------------------------------------------------</span>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="600" border="0" align="center" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right"><span
                                                                class="style60">เชื้อชาติ : </span></td>
                                                    <td>
                                                        <label for="origin"></label>
                                                        <input name="origin" type="text" id="origin"
                                                               value="<?php echo $row['origin']; ?>"></td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td height="19">&nbsp;</td>
                                                    <td style="text-align: right"><span class="style60">เพศ :</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4"><label for="address"></label>
                                                        <textarea name="address" id="textarea" cols="23"
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td style="text-align: right"><span
                                                                class="style60">โทรศัพท์ :</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label for="eduyear"></label>
                                                        <input type="text" name="eduyear" id="eduyear"
                                                               value="<?php echo $row['eduyear']; ?>"></td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                            ...
                                            <table width="600" border="0" cellpadding="0" cellspacing="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="reset" name="cancel" id="cancel" value="ยกเลิก">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
