        ...
        <div class="HeaderTitle">
          ...
          <div class="Block">
            ...
            <table width="170" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><span class="style64"><span style="color: #2192CF">ยินดีต้อนรับ</span> ::</span> <?php echo  '<span style="font-weight:bold; font-size:15px"> '.$_SESSION['username'].'</span>'; ?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
            ...
            error_reporting(E_ALL ^ E_NOTICE);
                  ...
                  <tr>
                    ...
                    <td><label for="nation"></label>
                      <input name="nation" type="text" id="nation" value="<?php echo $row['nation'];?>"h></td>
                    <td class="style60">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
