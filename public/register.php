                                            ...
                                            <table width="336" height="211" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td height="72" colspan="3" valign="top" bgcolor="#CCCCCC">&nbsp;&nbsp;หากคุณเคยลงทะเบียนเรียนหลักสูตรของทาง
                                                        <br>
                                                        &nbsp;&nbsp;วิทยาลัยชุมชนยะลาแล้ว คุณสามารถใส่ <strong
                                                                style="color: #060"> <br>
                                                            &nbsp;&nbsp;ชื่อล็อกอิน</strong> และ<strong
                                                                style="color: #060">รหัสผ่าน</strong> ของคุณ <br>
                                                        &nbsp;&nbsp;เพื่อเข้าไปลงทะเบียนเรียนหลักสูตรอื่นๆ ได้ <br></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" bgcolor="#CCCCCC"><? if (isset($std_error)) {
                                                            echo $std_error;
                                                        } ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td bgcolor="#CCCCCC">&nbsp;</td>
                                                    <td bgcolor="#CCCCCC"><input type="text" name="username"
                                                                                 id="username"/></td>
                                                    <td bgcolor="#CCCCCC">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td bgcolor="#CCCCCC">&nbsp;</td>
                                                    <td bgcolor="#CCCCCC"><br><input type="submit" name="submit"
                                                                                     id="ok2" value="เข้าสู่ระบบ"/>
