...
.style29 {color: #FFFFFF;  font-size: 16px; }
          ...
          <div class="Column1">
            <div class="Block">
              ...
              <table width="150" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td colspan="2">
                    <div align="center"><a href="register.php"><img src="images/register.gif" width="130"
                          height="35"></a></div>
                  </td>
                </tr>
              </table>
              ...
              <div class="BlockContentBorder">
                ...
                <ul>
                  <li><span class="style7"><a href="index.php"
                        style="color: #3987FB; text-decoration: none">หลักสูตรที่เปิด</a></span></li>
                  <li><span class="style7"><a href="manual.pdf"
                        style="color: #3987FB; text-decoration: none">คู่มือการลงทะเบียน</a></span></li>
                </ul>
              </div>
            </div>
                  ...
                  <tr>
                    <td width="304" height="251" valign="top">
                      <table width="298" height="224" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC"
                        bgcolor="#CCCCCC">
                        <tr bgcolor="#0099FF">
                          <td height="39" colspan="3" bgcolor="#0099FF"><span
                              class="style29">&nbsp;สำหรับผู้ที่ลงทะเบียนเรียนครั้งแรก</span></td>
                        </tr>
                        <tr>
                          <td height="81" colspan="3" valign="top" bgcolor="#CCCCCC">
                            &nbsp;&nbsp;หากคุณยังไม่เคยลงทะเบียนเรียนมาก่อน<br>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#CCCCCC"><input type="submit" name="button" id="button"
                              value="ลงทะเบียนเรียนใหม่" onClick="document.location.href='register_course.php'"></td>
                    ...
                    <td width="346" valign="top">
                      <form action="std_login_check.php" method="POST">
                        <table width="336" height="211" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="39" colspan="3" bgcolor="#0099FF"><span class="style29">
                                &nbsp;สำหรับผู้ที่เคยลงทะเบียนแล้ว</span></td>
                          </tr>
                          <tr>
                            <td height="72" colspan="3" valign="top" bgcolor="#CCCCCC">
                              &nbsp;&nbsp;หากคุณเคยลงทะเบียนเรียนหลักสูตรของทาง <br>
