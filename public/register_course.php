...
?>  
          ...
          <div class="Article">
            ...
            <table width="611" border="0" align="center" cellpadding="0" cellspacing="0" style="color: black">
              <tr>
            ...
            <table width="611" border="0" align="center" cellpadding="0" cellspacing="0" style="color: black">
              ...
              <form name="form1" method="post" action="">
                <table width="611" height="48" border="0" align="center" cellpadding="0" cellspacing="0" style="color:#000">
                  ...
                  <tr>
                    <td height="16" colspan="3" bgcolor="#CCCCCC" style="color: black">  1. กำหนด Username และ Password ที่ต้องการ </td>
                  </tr>
                  <tr>
                ...
                <table width="611" height="53" border="0" align="center" cellpadding="0" cellspacing="0" style="color: black">
                  <?php if($errmsg1) { ?>
                  <tr>
                  ...
                  <?php } ?>
                  <tr>
                    <td width="106" height="5" bgcolor="#FFFFFF" ><div align="left" style="color: black"> ชื่อล็อกอิน:</div></td>
                  ...
                  <?php } ?>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF"><div align="left" style="color: black">รหัสผ่าน:</div></td>
                    <td bgcolor="#FFFFFF"><div align="left">
                  ...
                  <?php } ?>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF"><div align="left" style="color: black">ยืนยันรหัสผ่าน:</div></td>
                    <td bgcolor="#FFFFFF"><div align="left">
                  ...
                  <tr>
                    <td height="1" colspan="2" bgcolor="#CCCCCC" style="color: black">  2. กรอกข้อมูลส่วนตัว</td>
                  </tr>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF">&nbsp;</td>
                    <td height="" bgcolor="#FFFFFF">&nbsp;</td>
                  ...
                  <?php } ?>
                  <tr>
                    <td bgcolor="#FFFFFF"><div align="left" style="color: black">คำนำหน้าชื่อ </div></td>
                  ...
                  <?php } ?>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF" style="color: black"><div align="left">นามสกุล</div></td>
                  ...
                  <?php } ?>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF" style="color: black"><div align="left" >วันเกิด</div></td>
                    <td height="1" bgcolor="#FFFFFF"><div align="left">
                  ...
                  <?php } ?>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF" style="color: black">ประเทศ</td>
            ...
            <!--     add gender    -->
                  ...
                  <?php } ?>
                  <tr>
                    <td height="1" bgcolor="#FFFFFF" style="color: black">เลขบัตรประชาชน</td>
                ...
                <table width="611" border="0" align="center" cellpadding="0" cellspacing="0" style="color: black">
                  ...
                  <tr>
                    <td colspan="4" bgcolor="#CCCCCC" style="color: black"> &nbsp;&nbsp;3.กรอบข้อมูลสำหรับการติดต่อ</td>
                  </tr>
                  <tr>
                    <td width="106">&nbsp;</td>
                    <td width="196">&nbsp;</td>
                  ...
                  <?php } ?><?php } ?>
                  <tr>
                    <td height="1" style="text-align: left; color: black">บ้านเลขที่</td>
                    <td><label>
                    ...
                    <td style="color: black">หมู่บ้าน/อาคาร</td>
                    <td><div align="left">
                  ...
                  <tr style="color: black">
                    <td height="32" style="text-align: left; color: black" >ซอย/ถนน</td>
                    <td>
                      ...
                      <span class="style29">*</span> </td>
                    <td style="color: black">แขวง/ตำบล</td>
                    <td><div align="left">
                  ...
                  <?php } ?><?php } ?>
                  <tr>
                    <td height="23" style="text-align: left; color: black">เขต/อำเภอ</td>
                    <td><div align="left">
                  ...
                  <?php } ?>
                  <tr>
                    <td height="30" style="text-align: left; color: black">รหัสไปรษณีย์</td>
                    <td><div align="left">
                  ...
                  <tr>
                    ...
                    <?php } ?>
                  <tr>
                    <td height="27" style="text-align: left; color: black">โทรศัพท์</td>
                  ...
                  <?php } ?>
                  <tr>
                    <td style="text-align: left; color: black">E-mail</td>
                ...
                <table width="613" border="0" align="center" cellpadding="0" cellspacing="0" style="color: black">
                  <tr>
                    <td colspan="3" bgcolor="#CCCCCC" style="color: black"> &nbsp;&nbsp;4.กรอบข้อมูลการศึกษา</td>
                  </tr>
                  <tr>
                    <td width="108">&nbsp;</td>
                    <td width="312">&nbsp;</td>
                    ...
                    <?php } ?>
                  <tr>
                    <td style="color: black">จบการศึกษาระดับ</td>
                    <td>
                  ...
                  <?php }?>
                  <tr>
                    <td style="color: black">จากสถานศึกษา</td>
                  ...
                  <tr>
                   ...
                   <?php } ?>
                  <tr>
                    <td style="color: black">ปีการศึกษา</td>
                ...
                <table width="611" border="0" align="center" cellpadding="0" cellspacing="0" style="color: black">
                  ...
                  <tr>
                    <td colspan="2" bgcolor="#CCCCCC" style="color: black">&nbsp;&nbsp;5. กรอบข้อมูลเีกี่ยวกับอาชีพ</td>
                  </tr>
                  <tr>
                    <td width="202">&nbsp;</td>
                    <td width="409">&nbsp;</td>
                  ...
                  <tr>
                    <td style="color: black">ลักษณะอาชีพที่ท่านประกอบอยู่</td>
                    <td><div align="left">
                      <label for=""></label>
                      <select name="job">
