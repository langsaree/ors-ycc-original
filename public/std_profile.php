                        ...
                        <table width="163" border="0" align="left" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td><span class="style64"><span
                                                style="color: #2192CF">Are welcome</span> ::</span> <?php echo '<span style="font-weight:bold; font-size:13px"> ' . $username . '</span>'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <table width="650" height="961" border="0" align="center" cellpadding="0" cellspacing="5">
                                <tr>
                                    ...
                                    <td width="659" height="951" align="right" valign="top">
                                        <div align="left">
                                            <p class="style55"><span class="style58"> :::<strong> Student information &#3623;&#3636;&#3607;&#3618;&#3634;&#3621;&#3633;&#3618;&#3594;&#3640;&#3617;&#3594;&#3609;&#3618;&#3632;&#3621;&#3634;</strong> :::</span><br>
                                            </p>
                                        </div>
                                        <?php
                                        ...
                                        <table width="637" height="62" border="0" cellpadding="0" cellspacing="5">
                                            <tr>
                                                <td
                                                        ...
                                                        width="435" height="30" valign="middle">&nbsp;
                                                </td>
                                                <td width="99" valign="middle" class="style33"><strong><a
                                                                href="profile_update.php?id=<?php echo $row["std_id"]; ?>"
                                                                class="style67" style="text-decoration: none">Edit
                                                            Profile</a></strong></td>
                                                <td style="text-align:left"><strong><a href="logout.php"><span
                                                                    class="glyphicon glyphicon-log-out"></span>Sign out</a></strong>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table width="600" border="0" align="center" cellpadding="0" cellspacing="2">
                                            ...
                                            <tr>
                                                ...
                                                <td><p><img src="image/std_infor.png" width="111" height="126"
                                                            align="top"/><br>
                                                        <span class="style62">Avatar</span></p></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                        ...
                                        <table width="600" border="0" align="center" cellpadding="0" cellspacing="5">
                                            <tr>
                                                ...
                                                <td width="196"
                                                    style="text-align: right; font-weight: bold; color: #333;">Login
                                                    name :</span></td>
                                                <td colspan="4"><?php echo $row['username']; ?>
                                            </tr>
                                            <tr>
                                                <td height="18" style="text-align: right">&nbsp;</td>
                                                <td style="text-align: right; color: #333; font-weight: bold;">password
                                                    :
                                                </td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right; font-weight: bold; color: #333;">name
                                                    :</span></span></td>
                                                <td colspan="4"><?php echo $row['f_name']; ?>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60">nationality :</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60">race : </span></td>
                                            ...
                                            <tr>
                                                <td height="19">&nbsp;</td>
                                                <td class="style60" style="text-align: right">Religion :</td>
                                            ...
                                            <tr>
                                                <td height="19">&nbsp;</td>
                                                <td style="text-align: right"><span class="style60">sex :</span></td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60">birthday : </span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right"><span
                                                            style="font-weight: bold; text-align: right;"><span
                                                                class="style61">ID card number<span
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60"
                                                                                    style="font-weight: bold">province :</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60">Zip code : </span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60">phone:</span></td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td class="style60" style="text-align: right">Graduated class:</td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td class="style60" style="text-align: right">From school :</td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td class="style60" style="text-align: right">province :</td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td class="style60" style="text-align: right">year :</td>
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td style="text-align: right"><span class="style60"
                                                                                    style="font-weight: bold">career :</span>
                                                </td>
