              ...
              <form name="form1" method="post" action="">
                ...
                <table width="611" height="53" border="0" align="center" cellpadding="0" cellspacing="0" class="black_color">
                  ...
                  <tr>
                    ...
                    <td height="1" bgcolor="#FFFFFF"><input type="text"  class="inputbox-normal" name="name" " id="name" style="background: <?php if($errmsg12) { echo "#EEFCE2"; ?>"value="<?php echo $name;} ?>/>
                ...
                <table width="611" border="0" align="center" cellpadding="0" cellspacing="0" class="black_color">
                  ...
                  <tr>
                    ...
                    <td><label>
                      <input type="text" class="inputbox-normal" name="home" id="textfield" style="background: <?php if(!empty($errmsg23)) { echo "#EEFCE2"; ?>" value="<?php $home;} ?>" >
                      <span class="style29">*</span></label></td>
                    <td class="black_color">หมู่บ้าน/อาคาร</td>
                    <td><div align="left">
                      <input name="m_home" class="inputbox-normal" type="text" id="m_home" size="10" style="background: <?php if(!empty($errmsg24)) { echo "#EEFCE2"; ?>" value="<?php $m_home; } ?>"  />
                      <span class="style29">*</span> &nbsp;</div></td>
                  </tr>
                  ...
                  <tr class="black_color">
                    ...
                    <td>
                      <input name="r_home" class="inputbox-normal" type="text" id="r_home" size="10" style="background: <?php if(!empty($errmsg25 )) { echo "#EEFCE2"; ?>" value="<?php $r_home;} ?>" />
                      <span class="style29">*</span> </td>
                    <td >แขวง/ตำบล</td>
                    <td><div align="left">
                      <input name="v_home" class="inputbox-normal" type="text" id="v_home" size="10" style="background: <?php if(!empty($errmsg26)) { echo "#EEFCE2"; ?>" value="<?php $v_home;} ?>" />
                      <span class="style29">*</span> &nbsp;</div></td>
                  </tr>
                 ...
                 <?php } ?>
                  ...
                  <tr>
                    ...
                    <td><label for="textfield4"></label>
                      <input type="text" name="eduprovince" id="textfield4" class="inputbox-normal" style="background:<?php if(!empty($errmsg33)) { echo "#EEFCE2"; ?>" value="<?php $eduprovince;} ?>" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><label for="textfield5"></label>
                      <input type="text" name="eduyear" id="textfield5" class="inputbox-normal" style="background:<?php if(!empty($errmsg34)) { echo "#EEFCE2"; ?>" value="<?php $eduyear;} ?>" /></td>
                    <td>&nbsp;</td>
                  </tr>
                </table>
                <table width="611" border="0" align="center" cellpadding="0" cellspacing="0" class="black_color">
