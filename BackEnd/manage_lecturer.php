  ...
  <table width="1251" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td><table width="95%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
        <tr>
          <td width="6%" height="100" align="center"><img src="image/lecture Manager.png" width="128" height="128" /></td>
     ...
     <span class="style37"><?php echo isset($success) ? $success : ''; ?><br />     
    ...
    <tr>
      <td><table width="431" height="169" border="0" cellpadding="0" cellspacing="0">
        <tr>
