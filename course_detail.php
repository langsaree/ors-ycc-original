    ...
    <div class="ArticleBorder">
        ...
        <div class="Article">
            ...
            <table width="611" border="0" align="center" cellpadding="0" cellspacing="2">
                <tr>
                    <td height="24" colspan="4" bgcolor="#333333"
                        style="font-weight: bold; color: #FFF; font-size: 14px;">&nbsp;&nbsp;ข้อมูลหลักสูตร
                    </td>
                </tr>
                <tr>
            ...
            <table width="611" border="0" align="center" cellpadding="0" cellspacing="2">
                <tr>
                    <td height="25" colspan="5" bgcolor="#333333"
                        style="color: #FFF; font-weight: bold; font-size: 14px;">&nbsp;&nbsp;รายละเอียดหลักสูตร
                    </td>
                </tr>
                <tr>
                    <td width="129">&nbsp;</td>
            ...
            <table width="200" border="0" align="center" cellpadding="0" cellspacing="2">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><a href="confirm_course.php?id=<?php echo $row['cos_id']; ?>"><img src="images/register1.jpg"
