...
?>  
          ...
          <div class="Article">
            ...
            <table width="611" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="16">&nbsp;</td>
                <td style="font-size: 12px"><li>กรณีไม่มีข้อมูลกรุณาใช้สัณลักษณ์<span class="style35"> <span class="style37"></span></span><span class="style36">-</span> แทน อย่าปล่อยให้ช่องว่างเปล่า</td>
                <td>&nbsp;</td>
              </tr>
            </table>
            <table width="611" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <li>
              <form name="form1" method="post" action="">
                ...
                <table width="611" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="2" bgcolor="#CCCCCC">&nbsp;&nbsp;5. กรอบข้อมูลเกี่ยวกับอาชีพ</td>
                    </tr>
                  <tr>
                    <td width="202">&nbsp;</td>
                    <td width="409">&nbsp;</td>
