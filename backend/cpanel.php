...
<table width="1024" border="0" cellpadding="1" cellspacing="2" >
  <tr>
    <td width="831" height="325" valign="top" ><table  width="819" height="250" border="0" cellpadding="0" cellspacing="2" >
      ...
      <tr>
        <td>&nbsp;</td>
        <td><a href="../public/register_course.php"><img src="image/manage register.png" alt="" class="second_image"/></a></td>
      ...
      <tr>
        <td class="style41">&nbsp;</td>
        <td class="style41"><a href="../public/register_course.php" class="style41">ลงทะเบียนวิชา</a></td>
