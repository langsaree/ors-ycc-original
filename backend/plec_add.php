...
$sql = "insert into lecturer (lec_id,lec_teach, lec_name, lec_tel, lec_email, lec_comment,username,password) values('$lec_id','$lec_teach','$lec_name','$lec_tel','$lec_email','$lec_comment','$username','$password')";
