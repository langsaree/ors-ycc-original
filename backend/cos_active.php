...
<table width="1024" border="0" cellpadding="0" cellspacing="0"> <?php error_reporting('E_ALL & ~E_NOTICE');
    if ($msg) { ?>
        <tr>
                    ...
                    <?php while ($row = mysqli_fetch_array($result)) { ?>
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top"><a
                                        href="cos_active.php?active=<?php echo $row['cos_id']; ?> "><img
                                            src="image/active.gif" width="20" height="18" border="0"
                                            align="middle"/></a></td>
                            <td align="center" valign="top"><a
                                        href="cos_active.php?non_active=<?php echo $row['cos_id']; ?>"><img
                                            src="image/non-active.jpg" width="16" height="16" border="0"/></a></td>
                        </tr>
                    <?php }//} ?>
                </table>
            </td>
