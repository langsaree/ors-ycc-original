...
<body>
<div align="center" class="style1">::: <span class="style4">The system has successfully added the name of the student !!!</span> :::</div>
<div align="center" class="style1">::: <span class="style3">Registration is complete Will move to the main page in 3 seconds</span> :::</div>
<?php
