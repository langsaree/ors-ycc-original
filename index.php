...
if(isset($_SESSION['username'])) {
    ...
    if ($_POST){
       ...
       if(!empty($username)&& !empty($password)){
          ...
          $result = mysqli_query($conn,$studentCheckLoginSQL);
          ...
          if(!empty($username)&& !empty($password)){
            $lecturerCheckLoginSQL = "select * from lecture where username = '$username' and password = '$password'";
            ...
            <table width="150" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <td></td>
                 ...
                 <tr>
                  ...
                  <p>&nbsp;</p>
                  <table width="150" border="0" align="0" cellpadding="0" cellspacing="0">
                    <tr>
                  ...
                  <table width="161" border="0" align="left" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                     <td width="72"><lable for="Submit"></lable>
                        <input type="submit" name="ok" id="ok" value="เข้าสู่ระบบ" /></td>
                     <td width="7">&nbsp;</td>
                     <td width="175"><lable><a href="password_recovery.php">ลืมรหัสผ่าน?</a></lable></td>
                    </tr>
                    <tr>
                    ...
                    <table width="150" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <?php } else { ?>
                          ...
                          <?php // If user already logined, so display welcome section below ?>
                          <?php echo ' ';?>
                          <?php 
                        ...
                        <div class="ArticleBorder">
                          ...
                          <div class="Article">
                            ...
                            <table width="601" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td height="26" colspan="3" style="color: #333; font-size: 16px; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-weight: bold;">  
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<span

                                    class="Article">วิชาที่เปิดสอนประจำเดือน</span>มกราคม 2554
                                  </td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                         ...
                         <br>
                            <table width="570" border="0" align="center" cellpadding="0" cellspacing="2">
                                ...
                                <tr>
                                    <td width="93" rowspan="5" valign="top"><img src="images/untitled.jpg" alt=""
                                                                                 width="78" height="83"/></td>
                                    <td height="19" colspan="3"
                                        valign="top"><?php echo '<span style="color:red; font-size:15px;  font-weight: bolder;">' . 'หมู่วิชา' . $row['cos_group'] . '</span>' ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2"><span
                                                class="o">ชื่อวิชา :: &nbsp;</span> <?php echo $row['cos_name']; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><a href="course_detail.php?id=<?php echo $row['cos_id']; ?>"
                                           style="color: #333; text-decoration: none"">ดูรายละเอียด</a></td>
                                    <td height="16">&nbsp;</td>
                                </tr>
                                <?php } ?>
                            </table>
