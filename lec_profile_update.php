		    ...
		    ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input type="text" name="login" id="login" class="inputbox-normal" value="<?php $row["username"]?>">
                 </td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <input type="text" name="name" id="name" class="inputbox-normal" value="<?php $row["lec_name"]?>" ></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <input type="text" name="email" id="email" class="inputbox-normal" value="<?php $row["lec_email"]?>" ></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <input type="text" name="phone" id="phone" class="inputbox-normal" value="<?php $row["lec_tel"]?>" ></td>
                  <td>&nbsp;</td>
                </tr>
            </table>
